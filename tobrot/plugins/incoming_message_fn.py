...
async def incoming_message_f(client, message):
    ...
    if message.reply_to_message:
        ...
        await i_m_sefg.edit("🤷How Can I Leech Without Any Source Link🚶")
        return
...
async def rename_tg_file(client, message):
    ...
    if not message.reply_to_message:
        await message.reply("🤷How Can I Leech Without Any Source Link🚶", quote=True)
        return
